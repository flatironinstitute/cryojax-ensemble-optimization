...
from cryojax.image.operators import CircularCosineMask, FourierGaussian
...
def simulate_relion_dataset(config: dict):
    ...
    particle_parameters = _make_particle_parameters(jnp.array(subkeys), config)
    ...
    logging.info("Images generated. Saved to {}".format(config["path_to_relion_project"]))
    return
